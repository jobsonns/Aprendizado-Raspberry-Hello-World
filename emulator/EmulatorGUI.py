...
from emulator.TypeChecker import typeassert

#http://www.tutorialspoint.com/python/tk_button.htm
from emulator.PIN import PIN
...
class App(threading.Thread):
    ...
    def run(self):
        ...
        # GPIO14
        pin8btn = Button(text="GPIO14\nOUT=0", command="14", padx="1px", pady="1px", bd="0px", fg="blue",
        ...
        # GPIO15
        pin10btn = Button(text="GPIO15\nOUT=0", command="15", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO23
        pin16btn = Button(text="GPIO23\nOUT=0", command="23", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO24
        pin18btn = Button(text="GPIO24\nOUT=0", command="24", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO25
        pin22btn = Button(text="GPIO25\nOUT=0", command="25", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO08
        pin24btn = Button(text="GPIO8\nOUT=0", command="8", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO07
        pin26btn = Button(text="GPIO7\nOUT=0", command="7", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO12
        pin32btn = Button(text="GPIO12\nOUT=0", command="12", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO20
        pin38btn = Button(text="GPIO20\nOUT=0", command="20", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO21
        pin40btn = Button(text="GPIO21\nOUT=0", command="21", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO02
        pin03btn = Button(text="GPIO2\nOUT=0", command="2", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO03
        pin05btn = Button(text="GPIO3\nOUT=0", command="3", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO10
        pin19btn = Button(text="GPIO10\nOUT=0", command="10", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO09
        pin21btn = Button(text="GPIO9\nOUT=0", command="9", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
        ...
        # GPIO11
        pin23btn = Button(text="GPIO11\nOUT=0", command="11", padx="1px", pady="1px", bd="0px", fg="blue",
                          relief="sunken", activeforeground="blue")
